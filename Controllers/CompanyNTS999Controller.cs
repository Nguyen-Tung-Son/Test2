...
namespace Test2.Controllers
{
    public class CompanyNTS999Controller : Controller
    {
        ...
        public CompanyNTS999Controller(AppliactionDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CompanyNTS999 != null ? 
                          ...
                          Problem("Entity set 'AppliactionDbContext.CompanyNTS999'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'AppliactionDbContext.CompanyNTS999'  is null.");
            }
            var companyNTS999 = await _context.CompanyNTS999.FindAsync(id);
            if (companyNTS999 != null)
            {
